...
class ViewInvestmentByNomineeWidget extends StatefulWidget {
  const ViewInvestmentByNomineeWidget({
    Key? key,
    this.id,
    this.category,
  }) : super(key: key);
  ...
  @override
  _ViewInvestmentByNomineeWidgetState createState() =>
      _ViewInvestmentByNomineeWidgetState();
}

class _ViewInvestmentByNomineeWidgetState
    extends State<ViewInvestmentByNomineeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: ViewDocumentByNomineeCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final viewInvestmentByNomineeViewDocumentByNomineeResponse =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: insurerTextFieldController ??=
                                    ...
                                    text: getJsonField(
                                      viewInvestmentByNomineeViewDocumentByNomineeResponse
                                          .jsonBody,
                                      r'''$.insurer''',
                                    ).toString(),
                                  ),
